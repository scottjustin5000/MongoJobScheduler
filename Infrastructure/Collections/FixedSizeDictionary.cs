...
{
   /// <summary>
   /// Represents a fixed-dictionary collection.
   /// </summary>
   public sealed class FixedSizeDictionary<TKey, TValue> : DictionaryBase<TKey, TValue>, IDictionaryWrapper<TKey, TValue>
   {
      ...
      /// </summary>
      public FixedSizeDictionary (DictionaryBase<TKey, TValue> values)
      {
         _values = values;
      }
      ...
      {
         throw new NotSupportedException("The collection is fixed-size.");
      }
